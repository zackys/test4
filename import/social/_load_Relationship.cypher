...
MATCH (n1:Person {userId:line.userId}), (n2:Company {companyId:line.companyId})
...
MATCH (n1:Person {userId:line.userId}), (n2:Project {projectId:line.projectId})
...
MATCH (n1:Person {userId:line.userId}), (n2:Interest {interestId:line.interestId})
